...
class hashcash extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
//Encryption Methods
//  final iv = IV.fromUtf8("solve");
...
//  final encrypted = encrypter.encrypt(plainText, iv: iv);
    return Scaffold(
      appBar: null,
      body: prefix0.FlatButton(
        onPressed: () {
          test();
        },
        color: prefix0.Colors.purple,
      ),
    );
  }
}
...
void test() {
  String secret = "000000112019-10-19 21:01:35.31";
  bool fake = true;
